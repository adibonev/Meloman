...
import { ImageRevealForm } from "./image-reveal-form";

export default async function NewImageRevealQuestionPage({
  params,
}: {
  ...
  return (
    <div className="mx-auto max-w-2xl space-y-6">
      ...
      <ImageRevealForm quizId={parent.quizId} roundId={parent.roundId} />
    </div>
  );
}
