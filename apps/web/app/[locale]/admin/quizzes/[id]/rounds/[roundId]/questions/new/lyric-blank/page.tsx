...
import { LyricBlankForm } from "./lyric-blank-form";

export default async function NewLyricBlankQuestionPage({
  params,
}: {
  ...
  return (
    <div className="mx-auto max-w-2xl space-y-6">
      ...
      <LyricBlankForm quizId={parent.quizId} roundId={parent.roundId} />
    </div>
  );
}
